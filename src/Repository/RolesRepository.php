...
class RolesRepository extends ServiceEntityRepository
{
    ...
    public function findWhereCodeLike($value)
    {
        return $this->createQueryBuilder('r')
            ->andWhere('r.code LIKE :val')
    ...
    public function findLastWhereCodeLike($value)
    {
        $lastGEstMatRole = $this->createQueryBuilder('r')
            ->andWhere('r.code LIKE :val')
            ->setParameter('val', $value.'%')
            ->orderBy('r.id', 'DESC')
            ->setMaxResults(1)
            ...
            return ($lastGEstMatRole) ? $lastGEstMatRole[0] : null;
    }
