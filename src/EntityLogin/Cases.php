...
use App\EntityLogin\FileRevisions;
...
class Cases
{
    ...
    private $questionnaire;
     ...
     /**
     * @ORM\ManyToOne(targetEntity=FileRevisions::class)
     * @ORM\JoinColumn(name="last_modified_revision" ,  nullable= false , referencedColumnName="id")
     */
    ...
    public function getLastModifiedRevision(): ?FileRevisions
    {
        return $this->lastModifiedRevision;
    }

    public function setLastModifiedRevision(FileRevisions $lastModifiedRevision): self
    {
