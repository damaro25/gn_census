 ...
 * Cases
 *
 * @ORM\Table(name="cases", uniqueConstraints={@ORM\UniqueConstraint(name="cases_id", columns={"id"})}, indexes={@ORM\Index(name="cases_last_modified_revision_key", columns={"last_modified_revision", "key"}), @ORM\Index(name="casesdeletedkeyfileorder", columns={"deleted", "key", "file_order"})})
 * @ORM\Entity
 */
class Cases
{
   ...
   /**
     ...
     * @ORM\Id
     * @ORM\GeneratedValue
     * @ORM\Column(type="integer" , name="clePimaire")
     */
    private $clePimaire;
    ...
    public function getClePimaire(): ?int
    {
        return $this->clePimaire;
    }
